from schedulizer import PriorityPreemptive

def test_priority_preemptive_normal_execution():
    print("Test 03: Priority Preemptive - Normal Execution")
    predefined_processes = [(1, 5, 10, 3), (2, 8, 5, 1), (3, 12, 8, 2)]
    priority = PriorityPreemptive()
    priority.schedulingProcess(predefined_processes)

def test_priority_preemptive_empty_input():
    print("Test 03: Priority Preemptive - Empty Input")
    priority = PriorityPreemptive()
    priority.processData(0)

def test_priority_preemptive_single_process():
    print("Test 03: Priority Preemptive - Single Process")
    priority = PriorityPreemptive()
    priority.processData(1)

def test_priority_preemptive_negative_values():
    print("Test 03: Priority Preemptive - Negative Values")
...
def test_priority_preemptive_large_number_of_processes():
    print("Test 03: Priority Preemptive - Large Number of Processes")
